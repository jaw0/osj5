...
#ifndef __stm32u5_i2c_impl_h__
#define __stm32u5_i2c_impl_h__
...
static inline void i2c_pins_init(int i, int altpins){
    ...
    case 4:
        ...
        switch(altpins){
        case 0:
            gpio_init( GPIO_D0, mode ); // cl
            gpio_init( GPIO_D1, mode ); // da
            break;
        case 1:
            mode = GPIO_AF(2) | GPIO_OPEN_DRAIN | GPIO_SPEED_HIGH ;
            gpio_init( GPIO_H4, mode ); // cl
            gpio_init( GPIO_H5, mode ); // da
            break;
        case 2:
            gpio_init( GPIO_J0, mode ); // cl
            gpio_init( GPIO_J1, mode ); // da
            break;
        }
    case 5:
        RCC->APB1ENR2   |= 1<<7;
        ...
        case 0:
            ...
            break;
        case 1:
            gpio_init( GPIO_F0, mode ); // cl
            gpio_init( GPIO_F1, mode ); // da
            break;
        case 2:
            gpio_init( GPIO_J9, mode ); // cl
            gpio_init( GPIO_J10, mode ); // da
            break;
        }
