...
typedef struct
{
  ...
  __IO uint32_t ODR;      /*!< GPIO port output data register,        Address offset: 0x14      */
    /* bsrr(L+H) => bsrr for f103 compat. --jaw 4/2013 */
  __IO uint32_t BSRR;     /*!< GPIO port bit set/reset register,      Address offset: 0x18      */
  __IO uint32_t LCKR;     /*!< GPIO port configuration lock register, Address offset: 0x1C      */
    /* renamed AFR[2] => (L+H) to match documentation. --jaw 4/2013 */
...
typedef struct
{
  ...
  __IO uint32_t  RESPCMD;        /*!< SDIO command response register, Address offset: 0x10 */
  __IO uint32_t  RESP1;          /*!< SDIO response 1 register,       Address offset: 0x14 */
  __IO uint32_t  RESP2;          /*!< SDIO response 2 register,       Address offset: 0x18 */
  __IO uint32_t  RESP3;          /*!< SDIO response 3 register,       Address offset: 0x1C */
  __IO uint32_t  RESP4;          /*!< SDIO response 4 register,       Address offset: 0x20 */
  __IO uint32_t DTIMER;         /*!< SDIO data timer register,       Address offset: 0x24 */
  __IO uint32_t DLEN;           /*!< SDIO data length register,      Address offset: 0x28 */
  __IO uint32_t DCTRL;          /*!< SDIO data control register,     Address offset: 0x2C */
  __IO uint32_t  DCOUNT;         /*!< SDIO data counter register,     Address offset: 0x30 */
  __IO uint32_t  STA;            /*!< SDIO status register,           Address offset: 0x34 */
  __IO uint32_t ICR;            /*!< SDIO interrupt clear register,  Address offset: 0x38 */
  __IO uint32_t MASK;           /*!< SDIO mask register,             Address offset: 0x3C */
  uint32_t      RESERVED0[2];   /*!< Reserved, 0x40-0x44                                  */
  __IO uint32_t  FIFOCNT;        /*!< SDIO FIFO counter register,     Address offset: 0x48 */
...
typedef struct 
{
  ...
  __IO uint32_t CSR[64];   /*!< HASH context swap registers,    Address offset: 0x0F8-0x1F7 */
